...
mod tests {
    ...
    fn test_render_chap7() {
        ...
        floor.material.pattern = PatternType::Solid(Color::new(1.0, 0.9, 0.9));
        ...
        left_wall.material.pattern = PatternType::Solid(Color::new(1.0, 0.9, 0.9));
        ...
        right_wall.transform = Matrix::translate(0.0, 0.0, 5.0)
            ...
            .multiply(&Matrix::rotate_x(std::f64::consts::PI / 2.0))
            .multiply(&Matrix::scale(10.0, 0.01, 10.0));
        right_wall.material.pattern = PatternType::Solid(Color::new(1.0, 0.9, 0.9));
        right_wall.material.specular = 0.0;
        w.objects.push(right_wall);

        let mut middle = Shape::sphere();
        middle.transform = Matrix::translate(-0.5, 1.0, 0.5);
        middle.material.pattern = PatternType::Solid(Color::new(0.1, 1.0, 0.5));
        ...
        right.material.pattern = PatternType::Solid(Color::new(0.5, 1.0, 0.1));
        ...
        left.material.pattern = PatternType::Solid(Color::new(1.0, 0.8, 0.1));
    ...
    fn test_render_chap9() {
        ...
        floor.material.pattern = PatternType::Stripe(Box::new(PatternType::Solid(Color::new(1.0, 0.5, 0.5))), Box::new(PatternType::Solid(Color::new(0.5, 1.0, 0.5))));
        ...
        left_wall.material.pattern = PatternType::Gradient(Box::new(PatternType::Solid(Color::new(1.0, 0.5, 0.5))), Box::new(PatternType::Solid(Color::new(0.5, 1.0, 0.5))));
